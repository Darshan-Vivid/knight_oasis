                ...
                <div class="ko-loginRegister-from">
                    ...
                    <form action="{{ route('auth.signup') }}" method="POST">
                        ...
                        <div class="ko-row">
                            <div class="ko-col-6">
                                <div class="ko-loginRegister-grp">
                                    ...
                                    <input type="text" class="ko-loginRegister-control @error('name') is-invalid @enderror"
                            ...
                            <div class="ko-col-6">
                                <div class="ko-loginRegister-grp">
                                    ...
                                    <input type="email" class="ko-loginRegister-control @error('email') is-invalid @enderror"
                            ...
                            <div class="ko-col-12">
                                <div class="ko-loginRegister-grp">
                                    ...
                                    <input type="password" class="ko-loginRegister-control @error('password') is-invalid @enderror"
                            ...
                            <div class="ko-col-12">
                                <div class="ko-loginRegister-grp">
                                    ...
                                    <input type="password" class="ko-loginRegister-control @error('password_confirmation') is-invalid @enderror"
                        ...
                        <p>Your personal data will be used to support your experience throughout this website, to manage
                            access to your account, and for other purposes described in our <a href="#">Privacy policy</a>.</p>
            ...
            if (inputVal.startsWith("+")) {
                ...
                if (matchedCodes.length > 0) {
                    matchedCodes.forEach(code => {
                        $("#country_code").append(`<option value="${code}">${code}</option>`); // Add matched codes
                    });
                } else {
                    allCodes.forEach(code => {
                        $("#country_code").append(`<option value="${code}">${code}</option>`); // Restore all codes
                    });
                }
            }
        });
